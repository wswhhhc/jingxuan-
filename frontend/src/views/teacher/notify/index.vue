    ...
    <section class="workspace-section workspace-section--soft reveal-up">
      <div class="workspace-toolbar">
        <div class="workspace-toolbar__body">
          ...
          <p class="workspace-toolbar__desc">把系统提醒、评审相关消息和未读状态整理成一份可持续阅读的消息册。</p>
        </div>
...
import { getNotifyList, markAsRead, markAllRead } from '@/api/teacher/notify'
import type { NotifyItem } from '@/api/teacher/notify'
...
const emitNotifyChanged = () => {
  window.dispatchEvent(new CustomEvent('teacher-notify-changed'))
}
